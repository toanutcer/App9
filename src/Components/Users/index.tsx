  ...
  return (
    <View style={styles.list}>
      <View style={styles.listImages}>
        <Image style={styles.images} source={IMAGES.bright} />
        <Image style={styles.images} source={IMAGES.reading} />
        <Image style={styles.images} source={IMAGES.tokyo} />
        <Image style={styles.images} source={IMAGES.office} />
        <LinearTextGradient
