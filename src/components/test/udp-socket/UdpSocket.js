...
export default class UdpSocket extends EventEmitter {
  ...
  send(msg, offset, length, port, address, callback) {
    ...
    if (port === undefined || address === undefined) {
      throw new Error(
        'socket.send(): address and port parameters must be provided',
      );
    }
    if (Array.isArray(msg) && (offset !== undefined || length !== undefined)) {
      throw new Error(
        'socket.send(): offset and length must be undefined for a msg of type Array',
      );
    }
    // Generate msg buffer
  ...
  setMulticastInterface(multicastInterface) {
    console.warn(
      'react-native-udp: setMulticastInterface() is not implemented',
    );
  }
  ...
  addMembership(multicastAddress, multicastInterface) {
    ...
    if (multicastInterface) {
      console.warn(
        'react-native-udp: addMembership() ignores `multicastInterface` parameter',
      );
    }
  ...
  addSourceSpecificMembership(sourceAddress, groupAddress, multicastInterface) {
    console.warn(
      'react-native-udp: addSourceSpecificMembership() is not implemented',
    );
  }
  ...
  dropMembership(multicastAddress, multicastInterface) {
    ...
    if (multicastInterface) {
      console.warn(
        'react-native-udp: dropMembership() ignores `multicastInterface` parameter',
      );
    }
  ...
  dropSourceSpecificMembership(
    ...
    console.warn(
      'react-native-udp: dropSourceSpecificMembership() is not implemented',
    );
  }
